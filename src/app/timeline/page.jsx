...
const iconMap = {
  Call: <TbPhoneCall className="text-green-500 text-3xl" />,
  Text: <MdOutlineTextsms className="text-blue-500 text-3xl" />,
  Video: <MdOutlineVideocam className="text-purple-500 text-3xl" />,
};
        ...
        filteredTimeline.map((item) => (
          ...
          >
            <div className='flex gap-6'>
              <p className='flex items-center'>{iconMap[item.type]}</p>
